...
class AppLocalizations {
  ...
  String get profile_tab_lists => _isEn ? 'Lists' : 'リスト';
  ...
  String get talk_list_tab_all => _isEn ? 'All' : '全て';
  String get talk_list_tab_feeds => _isEn ? 'Feeds' : 'フィード';
  String get talk_list_tab_lists => _isEn ? 'Lists' : 'リスト';
  String get talk_list_tab_dm => _isEn ? 'DM' : 'DM';
  String get online => _isEn ? 'Online' : 'オンライン';
  String by_handle(String handle) => _isEn ? 'by @$handle' : 'by @$handle';
  String get empty_list => _isEn ? 'No items to display' : '表示する項目がありません';
  String dm_fetch_error(String error) => _isEn ? 'Failed to fetch messages: $error' : 'メッセージ取得失敗: $error';
  String dm_send_error(String error) => _isEn ? 'Failed to send message: $error' : '送信失敗: $error';
  String get font_family_noto => _isEn ? 'Noto Sans JP' : 'Noto Sans JP';
  String get font_family_roboto => _isEn ? 'Roboto' : 'Roboto';
  String get font_family_georgia => _isEn ? 'Georgia (Serif)' : 'Georgia (Serif)';
  String get send_dm => _isEn ? 'Send DM' : 'DMを送る';
  String get notifications_suffix_san => _isEn ? '' : ' さん';
  String notifications_others_count(int count) => _isEn ? ' and $count others' : '、他$count人';
  String get days => _isEn ? 'd' : '日';
  ...
  String get chat_default_title => _isEn ? 'Bluesky Timeline' : 'Bluesky タイムライン';
  String get system => _isEn ? 'System' : 'システム';
